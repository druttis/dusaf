...
public final class InjectorImpl implements Injector {
    ...
    public <T> T newInstance(final Constructor<T> constructor, final boolean injectMembers) {
        ...
        final T instance = ReflectionUtils.newInstance(constructor, initargs);
        if (injectMembers) {
    ...
    public void injectFields(final Object instance) {
        ...
        ReflectionUtils.getDeclaredFields(type, INJECT_ANNOTATED).forEach((field) -> injectField(instance, field));
    }
    ...
    public void injectMethods(final Object instance) {
        final Class<?> type = instance.getClass();
        ReflectionUtils.getDeclaredMethods(type, INJECT_ANNOTATED).forEach((method) -> injectMethod(instance, method));
    }
    ...
    void bindProviderMethods() {
        ReflectionUtils.getDeclaredMethods(moduleType, PROVIDES_ANNOTATED).forEach((method) -> {
